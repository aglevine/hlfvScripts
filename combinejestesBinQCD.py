...
def startUnc(channel):
	...
	f.write(channelName + 'mutau signal,ww,ttbar,singlet,ztautau,zjetsother,wjets,qcd,SMVBF126,SMGG126,WWGG126,WWVBF126  lumi 1.026\n') 
	f.write(channelName + 'mutau signal,ww,ttbar,singlet,ztautau,zjetsother,wjets,qcd,SMVBF126,SMGG126,WWGG126,WWVBF126  Effi_Mu  1.02\n')
	f.write(channelName + 'mutau signal,ww,ttbar,singlet,ztautau,zjetsother,wjets,qcd,SMVBF126,SMGG126,WWGG126,WWVBF126  Effi_Tau 1.06\n') 
	f.write('\n')
	f.write('\n')
	f.write('\n')
	...
	f.write(channelName + 'mutau wjets Norm_WJets 1.1\n')
        f.write(channelName + 'mutau qcd Norm_QCD 1.1\n')
	f.write('\n')
	f.write('\n')
	f.write('\n')
	...
	u.write('Norm_WJets lnN\n')
        u.write('Norm_QCD lnN\n')
...
nonefile_str = "LFV_" + channel+"_collMass_type1_zjetsEmbed_dyshape_newSignal.root"
...
qcd = nonefile.Get("vbfmutau/qcd")
wjets = nonefile.Get("vbfmutau/wjets")
...
makeBinShape(wjets,"wjets",outfile,channel)
makeBinShape(qcd,"qcd",outfile,channel)
