...
void printYieldsMuTau(){

        printf("GG category \n");
        getYields("FitPAS/mlfit.root","shapes_fit_s/datacard_MuTau_0Jet_new","Datacards_MuTauShapesRenamed_May28/LFV_gg0_jesshape_tesshape_uesshape_fakesshape_binshape.root","gg0mutau",10,15,false,true);
	//getYields("mlfit.root","shapes_fit_s/datacard_MuTau_0Jet_new","Datacards_MuTauShapesRenamed_May28/LFV_gg0_jesshape_tesshape_uesshape_fakesshape_binshape.root","gg0mutau",5,30,false,true);
        printf("\n\n");

        printf("Boosted category \n");
        getYields("FitPAS/mlfit.root","shapes_fit_s/datacard_MuTau_1Jet_new","Datacards_MuTauShapesRenamed_May28/LFV_gg1_jesshape_tesshape_uesshape_fakesshape_binshape.root","boostmutau",10,15,false,false);
        //getYields("mlfit.root","shapes_fit_s/datacard_MuTau_1Jet_new","Datacards_MuTauShapesRenamed_May28/LFV_gg1_jesshape_tesshape_uesshape_fakesshape_binshape.root","boostmutau",5,30,false,false);
        printf("\n\n");

        printf("VBF category \n");
        getYields("FitPAS/mlfit.root","shapes_fit_s/datacard_MuTau_2Jet_new","Datacards_MuTauShapesRenamed_May28/LFV_vbf_jesshape_tesshape_uesshape_fakesshape_binshape.root","vbfmutau",2,3,true,false);
        //getYields("mlfit.root","shapes_fit_s/datacard_MuTau_2Jet_new","Datacards_MuTauShapesRenamed_May28/LFV_vbf_jesshape_tesshape_uesshape_fakesshape_binshape.root","vbfmutau",1,6,true,false);
