...
higgsMass = ("Exact M(#mu#tau_{h}) (GeV)",50,"ROOT.TLegend(0.63,0.60,0.93,0.97,' ','brNDC')",100,145,True,300,50, "ROOT.TLegend(0.62,0.55,0.87,0.95,' ','brNDC')")
collMass_type1 = ("collinear M(#mu#tau_{h}) (GeV)",20,"ROOT.TLegend(0.63,0.60,0.93,0.97,' ','brNDC')",100,100,True,300,20, "ROOT.TLegend(0.62,0.55,0.87,0.95,' ','brNDC')")
...
mPt = ("#mu P_{T} [GeV]",5,"ROOT.TLegend(0.6,0.55,0.81,0.99,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.52,0.65,0.65,0.96,' ','brNDC')")

tPt = ("#tau P_{T} [GeV]",10,"ROOT.TLegend(0.55,0.50,0.85,0.87,' ','brNDC')",0,0,True,100,10,"ROOT.TLegend(0.55,0.50,0.85,0.87,' ','brNDC')")

tJetPt = ("Tau Jet P_{T}" , 10,"ROOT.TLegend(0.55,0.45,0.8,0.85,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.55,0.45,0.8,0.85,' ','brNDC')")

mEta = ("Muon #eta",10,"ROOT.TLegend(0.13,0.6,0.33,0.9,' ','brNDC')",0,0,False,0,10,"ROOT.TLegend(0.13,0.6,0.33,0.9,' ','brNDC')")

tEta = ("Tau #eta",10,"ROOT.TLegend(0.7,0.65,0.9,0.88,' ','brNDC')",-1,1,False,0,10,"ROOT.TLegend(0.7,0.65,0.9,0.88,' ','brNDC')")
