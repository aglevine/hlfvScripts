...
def startUnc(channel):
	...
	f.write(channelName + 'mutau LFVGG,SMGG126,WWGG126 Theo_PDF_gg 1.097\n')
	f.write(channelName + 'mutau LFVVBF,SMVBF126,WWVBF126 Theo_PDF_vbf 1.036\n')
	f.write('\n')
	if channel == "gg0":
		f.write(channelName + 'mutau LFVGG, SMGG126, WWGG126 Theo_UE 1.04\n')
        	f.write(channelName + 'mutau LFVVBF, SMVBF126, WWVBF126 Theo_UE 1.1\n')
	elif channel == "gg1":
		f.write(channelName + 'mutau LFVGG, SMGG126, WWGG126 Theo_UE 0.95\n')
                f.write(channelName + 'mutau WWVBF126 Theo_UE 1.0\n')
	elif channel == "vbf":
                f.write(channelName + 'mutau LFVGG, SMGG126, WWGG126 Theo_UE 0.90\n')
                f.write(channelName + 'mutau LFVVBF, SMVBF126, WWVBF126 Theo_UE 0.99\n')
	f.write('\n')
	...
	if channel == "gg1":
                f.write(channelName + 'mutau LFVVBF,SMVBF126, WWVBF126 Theo_Scale_vbf 1.015\n')
        if channel == "vbf":
                f.write(channelName + 'mutau LFVVBF,SMVBF126, WWVBF126 Theo_Scale_vbf 1.02\n')

        f.write(channelName + 'mutau ztautau, zjetsother Norm_ZTauTau 1.03\n')
        if channel == "gg0":
        	f.write(channelName + 'mutau ztautau  Norm_ZTauTau_mt_0Jet_extra 1.05\n')
        if channel == "gg1":
                f.write(channelName + 'mutau ztautau  Norm_ZTauTau_mt_1Jet_extra 1.05\n')
	if channel == "vbf": 
		f.write(channelName+ 'mutau ztautau Norm_ZTauTau_mt_vbf_extra 1.10\n')
        f.write(channelName + 'mutau zjetsother Norm_ZJetsOther 1.3\n')
	if channel == "vbf":
		f.write(channelName + 'mutau ww Norm_WW_mt_vbf_extra 1.5\n')
                f.write(channelName + 'mutau ttbar Norm_TT_mt_vbf_extra 1.33\n')
	...
	f.write(channelName + 'mutau signal,ww,ttbar,singlet,ztautau,zjetsother,SMVBF126,SMGG126,WWGG126,WWVBF126  Effi_Tau 1.06\n') 
        f.write(channelName + 'mutau signal,ww,ttbar,singlet,ztautau,zjetsother,SMVBF126,SMGG126,WWGG126,WWVBF126  Effi_Tau_highPt 1.03\n')
	f.write('\n')
	f.write('\n')
	f.write('\n')
	...
	if channel == "gg0":
		f.write(channelName + 'mutau fakes Norm_FAKES_mt_0Jet 1.1\n')
	f.write('\n')
	f.write('\n')
	f.write('\n')
	#if channel == "vbf":
	...
	f.write(channelName + 'mutau signal, ztautau, SMVBF126,SMGG126 shape_MuTau_TES 1\n')
	#if channel == "vbf":
	...
	u.write('\n')
        ...
        if channel == "gg0":
                u.write('Norm_ZTauTau_mt_0Jet_extra lnN\n')
        if channel == "gg1":
                u.write('Norm_ZTauTau_mt_1Jet_extra lnN\n')
        if channel == "vbf":
                u.write('Norm_ZTauTau_mt_vbf_extra lnN\n')
                u.write('Norm_WW_mt_vbf_extra lnN\n')
                u.write('Norm_TT_mt_vbf_extra lnN\n')
        u.write('Norm_ZJetsOther lnN\n')
	u.write('Norm_WW lnN\n')
	u.write('Norm_TT lnN\n')
	u.write('Norm_FAKES lnN\n')
	if channel == "gg0":
 		u.write('Norm_FAKES_mt_0Jet lnN\n')
	...
	u.write('\n')
	u.write('norm_JES_muhad lnN\n')
        u.write('norm_MET_muhad lnN\n')
...
def writeUpDownNorm(histo,histoUp,histoDown,histoname,channel,sys):
	...
	u = open(channelName+'mutau/unc.vals','a')
	if sys == "jes":
		normName = 'norm_JES_muhad'
	elif sys == "ues":
		normName = 'norm_MET_muhad'
	else:
...
nonedir = "jesnonesignalJune18_VHVV/"
#nonedir = "jesnoneMetFixedWWOtherZTauTauEmbeddedFakes/"
#nonedir = "jespfMetOct7/"
#nonedir = "jesnoneOldOtherpfMetOct15/"
...
#jesupdir = "jesplussignalMetFix_Oct15/"
#jesdowndir = "jesminussignalMetFix_Oct15/"
...
#fakesupdir = "FakesHighFixedMetjes_Oct20/"
#fakesdowndir = "FakesLowFixedMetjes_Oct20/"
doLoose = False
...
fakesupfile_str = "LFV_" + channel+"_collMass_type1_fakeRate_zjetsEmbed_newSignal.root"
fakesdownfile_str = "LFV_" + channel+"_collMass_type1_fakeRate_zjetsEmbed_newSignal.root"

#fakesupfile_str = "LFV_" + channel+"_collMass_fakeRate_zjetsEmbed_newSignal.root"
#fakesdownfile_str = "LFV_" + channel+"_collMass_fakeRate_zjetsEmbed_newSignal.root"
...
WZ = nonefile.Get("vbfmutau/WZ")
ZZ = nonefile.Get("vbfmutau/ZZ")
VHLFV = nonefile.Get("vbfmutau/VHLFV")
VHSM = nonefile.Get("vbfmutau/VHSM")
HWWVHTTH = nonefile.Get("vbfmutau/HWWVHTTH")
...
#outfile = ROOT.TFile(dirname+"/LFV_"+channel+"_pfMetFixjes.root","RECREATE")
#outfile = ROOT.TFile(dirname+"/LFV_"+channel+"_FixedWWOtherZTauTauEmbeddedFakes_test.root","RECREATE")
outfile = ROOT.TFile(dirname+"/LFV_"+channel+"_20PAS.root","RECREATE")
outfile.mkdir(dirname)
outfile.cd(dirname+"/")

fillEmptyBins(WZ,"wz",channel)
fillEmptyBins(ZZ,"zz",channel)
fillEmptyBins(VHSM,"vhsm",channel)
fillEmptyBins(VHLFV,"vhlfv",channel)
fillEmptyBins(HWWVHTTH,"hwwvhtth",channel)
