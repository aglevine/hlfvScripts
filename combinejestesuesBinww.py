...
def fillEmptyBins(histo,histoname,channel):
	minFillBin = histo.FindFirstBinAbove()
	maxFillBin = histo.FindLastBinAbove()
	for i in range(minFillBin,maxFillBin):
...
outfile = ROOT.TFile(dirname+"/LFV_"+channel+"_jesshape_tesshape_metshape_binshape.root","RECREATE")
outfile.mkdir(dirname)
outfile.cd(dirname+"/")

fillEmptyBins(fakes,"fakes",channel)
fillEmptyBins(ztautau,"ztautau",channel)
...
fillEmptyBins(ztautau_shape_JES_Up,"ztautau",channel)
fillEmptyBins(zjetsother_shape_JES_Up,"zjetsother",channel)
fillEmptyBins(ttbar_shape_JES_Up,"ttbar",channel)
fillEmptyBins(ww_shape_JES_Up,"ww",channel)
fillEmptyBins(singlet_shape_JES_Up,"singlet",channel)
fillEmptyBins(LFVVBF_shape_JES_Up,"LFVVBF",channel)
fillEmptyBins(LFVGG_shape_JES_Up,"LFVGG",channel)
fillEmptyBins(SMVBF126_shape_JES_Up,"SMVBF126",channel)
fillEmptyBins(SMGG126_shape_JES_Up,"SMGG126",channel)

fillEmptyBins(ztautau_shape_JES_Down,"ztautau",channel)
fillEmptyBins(zjetsother_shape_JES_Down,"zjetsother",channel)
fillEmptyBins(ttbar_shape_JES_Down,"ttbar",channel)
fillEmptyBins(ww_shape_JES_Down,"ww",channel)
fillEmptyBins(singlet_shape_JES_Down,"singlet",channel)
fillEmptyBins(LFVVBF_shape_JES_Down,"LFVVBF",channel)
fillEmptyBins(LFVGG_shape_JES_Down,"LFVGG",channel)
fillEmptyBins(SMVBF126_shape_JES_Down,"SMVBF126",channel)
fillEmptyBins(SMGG126_shape_JES_Down,"SMGG126",channel)

fillEmptyBins(ztautau_shape_TES_Up,"ztautau",channel)
fillEmptyBins(zjetsother_shape_TES_Up,"zjetsother",channel)
fillEmptyBins(ttbar_shape_TES_Up,"ttbar",channel)
fillEmptyBins(ww_shape_TES_Up,"ww",channel)
fillEmptyBins(singlet_shape_TES_Up,"singlet",channel)
fillEmptyBins(LFVVBF_shape_TES_Up,"LFVVBF",channel)
fillEmptyBins(LFVGG_shape_TES_Up,"LFVGG",channel)
fillEmptyBins(SMVBF126_shape_TES_Up,"SMVBF126",channel)
fillEmptyBins(SMGG126_shape_TES_Up,"SMGG126",channel)

fillEmptyBins(ztautau_shape_TES_Down,"ztautau",channel)
fillEmptyBins(zjetsother_shape_TES_Down,"zjetsother",channel)
fillEmptyBins(ttbar_shape_TES_Down,"ttbar",channel)
fillEmptyBins(ww_shape_TES_Down,"ww",channel)
fillEmptyBins(singlet_shape_TES_Down,"singlet",channel)
fillEmptyBins(LFVVBF_shape_TES_Down,"LFVVBF",channel)
fillEmptyBins(LFVGG_shape_TES_Down,"LFVGG",channel)
fillEmptyBins(SMVBF126_shape_TES_Down,"SMVBF126",channel)
fillEmptyBins(SMGG126_shape_TES_Down,"SMGG126",channel)

fillEmptyBins(ztautau_shape_MET_Up,"ztautau",channel)
fillEmptyBins(zjetsother_shape_MET_Up,"zjetsother",channel)
fillEmptyBins(ttbar_shape_MET_Up,"ttbar",channel)
fillEmptyBins(ww_shape_MET_Up,"ww",channel)
fillEmptyBins(singlet_shape_MET_Up,"singlet",channel)
fillEmptyBins(LFVVBF_shape_MET_Up,"LFVVBF",channel)
fillEmptyBins(LFVGG_shape_MET_Up,"LFVGG",channel)
fillEmptyBins(SMVBF126_shape_MET_Up,"SMVBF126",channel)
fillEmptyBins(SMGG126_shape_MET_Up,"SMGG126",channel)

fillEmptyBins(ztautau_shape_MET_Down,"ztautau",channel)
fillEmptyBins(zjetsother_shape_MET_Down,"zjetsother",channel)
fillEmptyBins(ttbar_shape_MET_Down,"ttbar",channel)
fillEmptyBins(ww_shape_MET_Down,"ww",channel)
fillEmptyBins(singlet_shape_MET_Down,"singlet",channel)
fillEmptyBins(LFVVBF_shape_MET_Down,"LFVVBF",channel)
fillEmptyBins(LFVGG_shape_MET_Down,"LFVGG",channel)
fillEmptyBins(SMVBF126_shape_MET_Down,"SMVBF126",channel)
fillEmptyBins(SMGG126_shape_MET_Down,"SMGG126",channel)
...
writeUpDownNorm(ztautau,ztautau_shape_MET_Up,ztautau_shape_MET_Down,"ztautau",channel,"ues")
...
writeUpDownNorm(LFVVBF,LFVVBF_shape_MET_Up,LFVVBF_shape_MET_Down,"LVFVBF",channel,"ues")
